...
class Handler {
    ...
    static errorHandler(err, req, res, next) {
        Log_1.default.error(err.stack);
        res.status(500);
        err.status = (err === null || err === void 0 ? void 0 : err.status) || 500;
        err.message = (err === null || err === void 0 ? void 0 : err.message) || "message";
        return res.status(err.status).send((0, sendresponse_1.sendErrorResponse)(err.message));
        const apiPrefix = Locals_1.default.config().apiPrefix;
